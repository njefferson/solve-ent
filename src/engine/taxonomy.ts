 ...
 */
export const REMEDIES: { readonly [K in Remedy]: { readonly name: string; readonly how: string } } = {
  'A1-ISOLATE': {
    name: 'undoing an operation on both sides to get one letter on its own',
    how:
      'To get a letter on its own, undo what is being done to it — and do the same thing to both sides. ' +
  ...
  'A2-PROPORTION': {
    ...
    how:
      'Write the two ratios the same way round: what you have over what the recipe takes, ' +
  ...
  'A3-UNITS': {
    ...
    how:
      'Write each conversion with the unit you are carrying on the BOTTOM, so it cancels the one above it. ' +
      'If a unit does not cancel, that factor is the wrong way up.',
  },
  'A4-MAGNITUDE': {
    name: 'checking the size of an answer before writing it down',
    how:
      'Before writing a number down, ask roughly how big it ought to be. ' +
