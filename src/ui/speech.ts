...
/** What speech this device can do. Absent is the normal case, not an error. */
export interface Voice {
  /** Speak text that is already on screen. */
  speak(text: string): void;
  /** Stop, immediately. A reader who wants it to stop wants it to stop now. */
  stop(): void;
}
 ...
 * they are not wrong.
 */
export function deviceVoice(): Voice | null {
